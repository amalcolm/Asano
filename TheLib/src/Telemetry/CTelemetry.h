...
class CTelemetry {
public:
    // The sink is called synchronously; copy fields before deferring work.
    using Sink = void (*)(const CTelemetry& telemetry, bool includeFrameMarkers, void* userData);
