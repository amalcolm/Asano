...
void CSerialWrapper::writeHandshakeResponse() {
  ...
  CFG::STATE_DURATION_uS,CFG::HEAD_SETTLE_TIME_uS,CFG::POT_UPDATE_OFFSET_uS,CFG::A2D_SAMPLING_SPEED_Hz,CFG::A2D_READING_PERIOD_uS,CFG::MAX_BLOCKSIZE,CFG::MAX_EVENTS_PER_BLOCK,CFG::DEVICE_VERSION,CFG::getDebugModeStr());
