...
## Context
- This is a PlatformIO/Arduino project for a Teensy4.1 testing a proptype fNIRS device, in the early stages of development.
- The parent solution, Asano, has a C# WinForms .NET 8 proect of the same name for data and telemetry display using OpenGL.
- The Parent folder haas a Master project which contains the device code for the main fNIRS device, and this uses the libraries of that project.
